...
class GuideConfig:
    ...
    # Control strength
    strength: float = 1.0
    # The edited texture, if have edited texture  u will skip generation process
    initial_texture: str = None

    #Editing text prompts
    edit_text: str = 'make it looks like the hulk'
    #Editing Model
    edit_model: str = 'Normal_Aware' ## two Options ['Depth_Aware','Normal_Aware'] 
    #junction_dialte_kernelsize
    junction_dialte_kernelsize: int = 12
    #generate_dialte_kernelsize
    generate_dialte_kernelsize: int = 15
    
    ## sculpture clothes
    # input_point: str = [[865,1833],[1185,1825],[1501,1849],[1177,1721],[1185,1149]]
    # input_label: str = [1,1,1,0,0]"
    
    # ## sculpture 
    input_point: str = "[[1129,977],[1173,1565],[1237,1689],[1005,1853],[1389,1845]]"
    input_label: str = "[1,1,1,0,0]"

    # # ## duck 
    # input_point: str = "[[1271,1332],[1189,1693],[1310,1674],[1182,1841],[1484,1914]]"
    # input_label: str = "[1,1,1,0,0]"

    # # ## duck stone
    # input_point: str = "[[1271,1332],[1189,1693],[1310,1674],[1182,1841],[1484,1914]]"
    # input_label: str = "[0,0,0,1,1]"

    #3D SAM in first view inputs
...
class LogConfig:
    ...
    # Experiment name
    exp_name: str = 'outputs'
    # Experiment output dir
    exp_root: Path = Path('exps_editing/')

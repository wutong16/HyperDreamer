...
from editing.src.utils import seed_everything
...
class StableDiffusion(nn.Module):
    ...
    def img2img_step(self, text_prompt, inputs, depth_mask, guidance_scale=100, strength=0.5,
        ...
        text_embeddings = self.get_text_embeds([text_prompt])
